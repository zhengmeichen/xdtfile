        ...
        with h5py.File(eachfile, 'r') as f:
            for group in f.keys():
                ...
                for k in f[group].keys():
                    if k=='ScnlinDay' or k=='ScnlinMillSecond':
                        continue
                    data = f[group + '/' + k][()]
                    try:
...
if __name__ == '__main__':
    file_re = '/FY3E/MWTS/1A/*/2022/20220701/FY3E_MWTS-_*_1A_*_OBC--_V0.HDF'
    out_path = '/STSS/FY3E_STSS/dev/AIWarning/MIC/MWTS/MWTS_MIC_sample.h5'
