...
if __name__ == '__main__':
    ...
    date = '202210'
    # date = sys.argv[1]
    file_re = '/STSS/FY3E_STSS/dev/AIWarning/Data/FY4B/GHI/202210*/FY4B_GHI_2022*_*_DT.h5'
    out_root = '/STSS/FY3E_STSS/dev/AIWarning/Param/GHI/'
    ...
    outputfileA = out_root + date + 'GHI_A.pkl'
    outputfileD = out_root + date + 'GHI_D.pkl'
