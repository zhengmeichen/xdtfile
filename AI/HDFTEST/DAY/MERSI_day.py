...
# 文件读取
filelist = sorted(glob.glob('/STSS/FY3E_STSS/dev/AIWarning/HDFTEST/HDF/MERSI/*.HDF'))
# 文件保存名称
...
# 文件输出路径
try:
    os.mkdir('/STSS/FY3E_STSS/dev/system/stweb/data/machine/FY3E/FY3E_MERSI/' + date)
except:
    pass
...
outfile = '/STSS/FY3E_STSS/dev/system/stweb/data/machine/FY3E/FY3E_MERSI/' + date + "/" + filename
