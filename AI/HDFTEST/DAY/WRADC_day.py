...
# 文件读取
filelist1 = sorted(glob.glob('/STSS/FY3E_STSS/dev/AIWarning/HDFTEST/HDF/WRADC/ASCENDC/*.HDF'))
filelist2 = sorted(glob.glob('/STSS/FY3E_STSS/dev/AIWarning/HDFTEST/HDF/WRADC/DESCENDC/*.HDF'))
...
# 文件输出路径
try:
    os.mkdir('/STSS/FY3E_STSS/dev/system/stweb/data/machine/FY3E/FY3E_WindRadC/' + date)
except:
    pass
...
outfile = '/STSS/FY3E_STSS/dev/system/stweb/data/machine/FY3E/FY3E_WindRadC/' + date + "/" + filename
