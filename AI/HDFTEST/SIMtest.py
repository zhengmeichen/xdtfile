...
filename = 'C:\\Users\\zhengmeichen\\Downloads\\FY3E_SIM--_SOLR_1A_20220103_0009_OBC--_V0.HDF'
outfilename = 'C:\\Users\\zhengmeichen\\Downloads\\FY3E_SIM--_SOLR_1A_20220103_OBC--_V0.HDF'
...
with h5py.File(filename, 'r') as f, h5py.File(outfilename, 'w') as o:
    ...
    # packgetime时间
    Daycnt = f['/Geolocation/Scnlin_daycnt'][:].astype('f4') * 24 * 60 * 60 * 1000
    Mscnt = f['/Geolocation/Scnlin_mscnt'][:].astype('f4')
